...
// ─────────────────────────────────────────────
// Mobile-optimised shader — same look as desktop, lighter GPU cost
// Performance savings: mediump precision, 0.3× DPR, 30fps cap (all invisible to user)
// Visual parity: same iteration count range, same colour palette, same glow brightness
// ─────────────────────────────────────────────
const SHADER_MOBILE = `#version 300 es
